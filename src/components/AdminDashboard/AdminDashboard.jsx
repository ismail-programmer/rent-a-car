                    ...
                    <ul className="vertical-nav-menu">
                      ...
                      <li className="mm-active">
                        ...
                        <ul className="mm-show">
                          ...
                          <li>
                            <a href="advertisement-dashboard.html">
                              Advertisement
                            </a>
                          </li>
                          <li>
                        ...
                        <ul>
                          ...
                          <li>
                            <a href="elements-loaders.html">
                              <i className="metismenu-icon"></i>Loading
                              Indicators
                            </a>
                          </li>
                          <li>
                      ...
                      <li>
                        <a href="widgets-chart-boxes.html">
                          <i className="metismenu-icon pe-7s-graph"></i>Chart
                          Boxes 1
                        </a>
                      </li>
                      <li>
                        <a href="widgets-chart-boxes-2.html">
                          <i className="metismenu-icon pe-7s-way"></i>Chart
                          Boxes 2
                        </a>
                      </li>
                      <li>
                        <a href="widgets-chart-boxes-3.html">
                          <i className="metismenu-icon pe-7s-ball"></i>Chart
                          Boxes 3
                        </a>
                      </li>
                      <li>
                        <a href="widgets-profile-boxes.html">
                          <i className="metismenu-icon pe-7s-id"></i>Profile
                          Boxes
                        </a>
                      </li>
                        ...
                        <ul>
                          ...
                          <li>
                            <a href="forms-textarea-autosize.html">
                              <i className="metismenu-icon"></i>Textarea
                              Autosize
                            </a>
                          </li>
                        </ul>
                      ...
                      <li>
                        <a href="charts-apexcharts.html">
                          <i className="metismenu-icon pe-7s-graph"></i>Apex
                          Charts
                        </a>
                      </li>
                      <li>
