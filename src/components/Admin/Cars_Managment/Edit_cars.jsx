...
class EditCar extends Component {
  ...
  deleteCar = e => {
    e.preventDefault();
    cars.splice(index, 1);
    this.popup(2, "/admin/cars_details");
    localStorage.setItem("carDetails", JSON.stringify(cars));
  };
  render() {
    return (
      <div className="app-container app-theme-white body-tabs-shadow">
        <Success color="green" name="Car" i={1} condition="Edited" />
        <Success color="red" name="Car" i={2} condition="Deleted" />
                      ...
                      <div className="form-row">
                        ...
                        <div className="col-md-6">
                          <div className="position-relative form-group">
                            ...
                            <input
                              required
                              defaultValue={cars[index].price.split("$")[1]}
                              ref="price"
                              id="Price"
